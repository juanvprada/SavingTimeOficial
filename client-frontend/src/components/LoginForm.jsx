        ...
        <section className="max-w-md mx-auto p-6 bg-transparent rounded-lg shadow-md mt-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                <div className="form-group">
                    <label className="block text-gray-900" htmlFor="email">Correo Electrónico</label>
                    <input
                ...
                <div className="form-group">
                    <label className="block text-gray-900" htmlFor="password">Contraseña</label>
                    <input
                        className="mt-1 p-2 border border-gray-300 rounded w-full focus:outline-none focus:ring focus:ring-green-200"
                        type="password"
                        id="password"
                ...
                <button className="w-full bg-green-600 text-gray-900 font-semibold py-2 rounded hover:bg-green-700 transition" type="submit">
                    Iniciar Sesión
                </button>
            </form>
            <p className="mt-4 text-center">
                <span className="text-gray-900">¿Has olvidado tu contraseña?</span>{' '}
                <button
